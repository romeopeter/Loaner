...
export default function SingleOffer() {
  ...
  useEffect(
    ...
    [dispatch, params.offerId, allBidsStatus]
  );
                ...
                <table className="table-auto w-full border-collapse border border-slate-500">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-black">
                        {/*NGN 10 billion*/}
                        {offer.tranche_id.size.currency}{" "}
                        {offer.tranche_id.size.minimum_subscription.amount}
                      </td>
                      <td className="border border-black">
                        NGN 5 billion
                        {/*****/}
                ...
                {offer !== null && (
                  <>
                    <span className="block">
                      {investorInitials(offer["deal_owner"])}
                    </span>
                ...
                >
                  ...
                  <Button
                    ...
                    buttonClass={`self-center ${
                      state.showBidFields ? "bg-red-300" : "bg-red-500"
