...
export default function OfferForm({ requestFormState, showSummary }) {
	...
	*/
    const formHeightIsExtended = state.secondSlideIn === true && formState.dealType === 'BOND';
    const secondSlideWillHide = state.lastSlideIn === true && formState.dealType === 'BOND';
    const secondSlideWillShow = state.lastSlideIn === false && formState.dealType === 'BOND';
    ...
    return (
        <div>
            <form
                ...
                style={{
                    height: formHeightIsExtended | secondSlideWillShow ? '1080px' : 'auto',
                }}
            >
                <div id='loan-request-steps'>
                        ...
                        <div className='grid grid-cols-1 gap-4'>
                            <div className='col-span-12'>
                                <select
                                    ...
                                    onChange={(e) => handleChange(e, 'generalTerms')}
                                    // required
                                >
                                    <option defaultValue=''>Select deal type</option>
                            ...
                            <div className='col-span-12'>
                                <select
                                    ...
                                    // required
                                >
                                    <option defaultValue=''>Client/Issuer</option>
                                    <option value='-'>-</option>
                                    <option value='-'>-</option>
                                </select>
                            </div>
                            ...
                            {/*White space*/}
                            <div className='col-span-12 mb-12'></div>
                            <div className='col-span-12 mb-12'></div>
                            {/*White space*/}
                    ...
                    <div
                        ...
                        ref={secondSlideRef}
                        style={{
                            visibility: secondSlideWillHide ? 'hidden' : secondSlideWillShow ? 'visible' : 'auto',
                        }}
                    >
                        <div id='terms-heading'>
                            ...
                            <div className='grid grid-cols-2 gap-4'>
                                <div className='col-span-2'>
                                    ...
                                    >
                                        ...
                                        <option value='allocated'>Books closed</option>
                            ...
                            <div className='grid grid-cols-2 gap-4'>
                                <div className='col-span-2'>
                                    <select
                                        ...
                                        onChange={(e) => handleChange(e, 'trancheSize')}
                                    >
                                ...
                                <div className='col-span-1'>
                                    <input
                                        ...
                                        id='tranche-value'
                                        className='mt-1 focus:ring-white block w-full sm:text-sm bg-gray-300 form-field general-issuer-terms'
                                        value={formState.trancheSize.discountValue}
                                        onChange={(e) => handleChange(e, 'trancheSize')}
                                    />
                                </div>
                                <div className='col-span-1'>
                                ...
                                <div className='col-span-1'>
                                    ...
                                    >
                                        <option defaultValue=''>Min subscription</option>
                                        <option value='5000000'>NGN 5,000,000</option>
                                        <option value='10000000'>NGN 10,000,000</option>
                                        <option value='25000000'>NGN 25,000,000</option>
                            ...
                            <div className='grid grid-cols-2 gap-4'>
                                    ...
                                    <>
                                        <div className='col-span-1'>
                                            <select
                                                ...
                                                name='couponType'
                                                className='mt-1 focus:ring-white block w-full sm:text-sm bg-gray-300 form-field'
                                                value={formState.pricing.couponType}
                                                onChange={(e) => handleChange(e, 'pricing')}
                                            >
                                                <option defaultValue=''>Coupon Type</option>
                                        ...
                                        <div className='col-span-1'>
                                            <input
                                                ...
                                                style={{
                                                    backgroundColor:
                                                        formState.pricing.couponType === 'floating'
                                                            ? '#d1d5db'
                                                            : '#888',
                                                    cursor:
                                                        formState.pricing.couponType === 'floating'
                                                ...
                                                value={formState.pricing.benchmark}
                                                onChange={(e) => handleChange(e, 'pricing')}
                                            />
                                        </div>
                                    </>
                                ...
                                <div className='col-span-1'>
                                    ...
                                    >
                                        ...
                                        <option value='book build'>Book build</option>
                                    </select>
                                </div>
                            </div>

                            <div className='grid grid-cols-2 gap-4 mt-5'>
                                {formState.pricing.offerType.name === 'fixed price' ? (
                                    <>
                                        <div className='col-span-1'>
                                            <input
                                                type='number'
                                                ...
                                                className='mt-1 focus:ring-white block w-full sm:text-sm bg-gray-300 form-field general-issuer-terms'
                                                value={formState.pricing.offerType.fixedPrice.rate}
                                                onChange={(e) =>
                                                    setFormState((state) => {
                                                        return {
                                                            ...state,
                                        ...
                                        <div className='col-span-1'>
                                            <input
                                                ...
                                                className='mt-1 focus:ring-white block w-full sm:text-sm bg-gray-300 form-field general-issuer-terms'
                                                value={formState.pricing.offerType.fixedPrice.yield}
                                                onChange={(e) =>
                                                    setFormState((state) => {
                                                        return {
                                                            ...state,
                                ...
                                {formState.pricing.offerType.name === 'book build' ? (
                                    <>
                                        <div className='col-span-1'>
                                            <input
                                                type='number'
                                    ...
                                    <>
                                        <div className='col-span-2'>
                                            <select
                                                ...
                                                className='mt-1 focus:ring-white block w-full sm:text-sm bg-gray-300 form-field'
                                                value={formState.pricing.couponFrequency}
                                                onChange={(e) => handleChange(e, 'pricing')}
                                            >
                                                <option defaultValue=''>Coupon frequency</option>
                                        ...
                                        <div className='col-span-2'>
                                            <h5 className='font-md text-white mb-2'>Call option</h5>
                                            <div className='flex justify-start text-white'>
                                                <div className='form-check mr-2'>
                                                    <label htmlFor='call-option-yes'>Yes</label>{' '}
                                                    <input
                                                        type='radio'
                                                        ...
                                                        checked={hiddenFieldTrigger.showCallOption}
                                                        value='yes'
                                                        onChange={(e) => {
                                                            setHiddenFieldTrigger((state) => {
                                                                return {
                                                ...
                                                <div className='form-check'>
                                                    <label htmlFor='call-option-no'>No</label>{' '}
                                                    <input
                                                        type='radio'
                                                        name='call-option-no'
                                                        id='call-option-no'
                                        ...
                                        <div className='col-span-2'>
                                            {hiddenFieldTrigger.showCallOption ? (
                                                <input
                                                    ...
                                                    id='call-option'
                                                    className='mt-1 focus:ring-white block w-full sm:text-sm bg-gray-300 form-field'
                                                    value={formState.pricing.callOption}
                        ...
                        <div id='form-slide-control' className='form-slide-button mt-5 mb-5 flex justify-between'>
                            <Button
                                title='Previous'
                        ...
                        <div className='grid grid-cols-1 gap-4 mt-5'>
                            ...
                            <div className='col-span-12'>
                                <select
                                    ...
                                    onChange={(e) => handleChange(e)}
                                >
                                    <option defaultValue=''>Eligible investor</option>
                                    <option value='all'>All</option>
                                    <option value='retail-investor-only'>Retail investors only</option>
                            ...
                            <div className='grid grid-cols-2 gap-4'>
                                <div className='col-span-2'>
                                    ...
                                    >
                                        ...
                                        <option value='standard-and-poors'>Standard & Poors</option>
