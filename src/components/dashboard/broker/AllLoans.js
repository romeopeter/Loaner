...
import { Flex, Box, Text, Table, Tbody, Tr, Td, Heading, Image } from '@chakra-ui/react';
                                    ...
                                    {LoanRequestData.map((data, index) => {
                                        return (
                                            <Tr key={index} borderBottom={'1px solid black'}>
                                                ...
                                                <Td borderRight={'1px  solid #c4c4c4'} maxW={'300px'} px={[8]}>
                                                    {data.desc}
                                                </Td>
                                                <Td color={'#008060'} cursor={'pointer'} textAlign={'center'}>
                                                    <Text as={Link} to='/broker/dashboard/loan-offer/'>
                                                        {data.details}
                                                    </Text>
                                                </Td>
                                            </Tr>
