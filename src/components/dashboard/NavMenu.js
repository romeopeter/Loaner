        ...
        if (role === 'Client') {
            return (
                <ul id='nav-menu-list' className='' ref={navMenuRef}>
                    <li id='deals' className='nav-menu-item dropdown' style={{ color: 'white', cursor: 'pointer' }}>
                        <div>
                ...
                <ul id='nav-menu-list' className='' ref={navMenuRef}>
                    <li id='deals' className='nav-menu-item dropdown' style={{ color: 'white', cursor: 'pointer' }}>
                        ...
                        <div id='deals-dropdown' className='shadow-md rounded'>
                            ...
                            <Link to={`/broker/dashboard/all-offers/`}>Successful offers</Link>
                            <Link to={`/broker/dashboard/all-offers/`}>Failed offers</Link>
                            <Link to={`/broker/dashboard/all-offers/`}>Accepted offers</Link>
                        </div>
                    </li>
                    <li
                ...
                <ul id='nav-menu-list' className='' ref={navMenuRef}>
                    <li id='deals' className='nav-menu-item dropdown' style={{ color: 'white', cursor: 'pointer' }}>
                        ...
                        <div id='deals-dropdown' className='shadow-md rounded'>
                            ...
                            <Link to={`/multiple-tranche-deal`}>Create deal - multiple tranche</Link>
                        </div>
                    </li>
                    <li
                        id='analysis-dropdown'
