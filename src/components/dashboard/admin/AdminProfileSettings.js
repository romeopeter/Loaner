							...
							<Tabs align={"end"} colorScheme={"#002275"} minH={"70vh"} isLazy>
								...
								<TabPanels>
									<TabPanel>
										<FormControl >
											<Flex mt={["10"]} flexDirection={["column", "row"]}>
												<Box flex={"1"} mr={["0","10"]}>
													...
													<FormLabel htmlFor='email' mt={["10"]}>Mobile No</FormLabel>
													<Input  type='tel' mb={["10"]} bgColor={"#C4C4C4"} borderRadius={"0"}/>
												...
												<Box flex={"1"}>
													...
													<Input  type='text' bgColor={"#C4C4C4"} borderRadius={"0"}/>
													<FormLabel htmlFor='email' mt={["10"]}>Email </FormLabel>
													<Input  type='email' mb={["10"]} bgColor={"#C4C4C4"} borderRadius={"0"}/>
											...
											<Box mt={["10"]}>
												<Heading color={"#002276"} fontSize="1.4em" fontWeight="medium" textAlign={"left"}>Basic Information</Heading>
										...
										<Button mt="10" p={["6"]} bg={"#008060"} color={"#fff"} _hover={{bg:"#008060"}}>Save changes</Button>
									</TabPanel>
									<TabPanel>
										<Flex justifyContent={"flex-start"} flexDirection={["column"]}>
											<Box id="avatar-container" boxShadow={"2xl"} w={["10em"]} h={["10em"]}></Box>
											<ButtonGroup color={"#fff"} mt={["10"]}>
												<Button bg="#008060" borderRadius={"0"} _hover={{bg:"#008060"}}>Change Avatar</Button>
												<Button bg="#D82C0D" borderRadius={"0"} _hover={{bg:"#D82C0D"}}>Delete Avatar</Button>
											</ButtonGroup>
										</Flex>
										<Button bottom="-200" p={["6"]} bg={"#008060"} color={"#fff"} _hover={{bg:"#008060"}}>Save changes</Button>
									...
									<TabPanel>
										...
										<Button bottom="-200" p={["6"]} bg={"#008060"} color={"#fff"} _hover={{bg:"#008060"}}>Update password</Button>
									</TabPanel>
								</TabPanels>
							</Tabs>
						</Flex>
